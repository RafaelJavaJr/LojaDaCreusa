			...
			<div class="menu-wrap">
				<nav class="menu">
					<div class="icon-list">
						...
						<a href="Product?p=electronic"><i class="fa fa-fw fa-laptop"></i><span>Eletrônicos
								and aplicações</span></a> <a href="Product?p=car"><i
		...
		<div class="container">
			<div class="select-box">
				<div class="select-city-for-local-ads ads-list">
					<label>Selecione Sua Cidade Para Ver Os Anúncios Locais</label> <select>
						<optgroup label="Cidades">
							<option selected style="display: none; color: #eee;">Selecione
								a Cidade</option>
							<option>Curitiba</option>
			...
			<div class="ads-grid">
				<div class="side-bar col-md-3">
					<div class="search-hotel">
						<h3 class="agileits-sear-head">O Nome Contêm</h3>
						<form>
